...
*Стоимость генерации: 1 токен*`,
  ...
  WELCOME_NEW_USER: `🎤 *Добро пожаловать в Авто Бит Бот!*
...
⏳ Обычно это занимает 1-2 минуты.`,
  ...
  ERROR_DEDUCT: 'Ошибка при списании токенов',
...
За каждого приглашённого друга вы получите *1 токен*! 🎁`,
...
Нажмите кнопку ниже для оплаты:`,
  ...
  NOT_ENOUGH_CREDITS_RETRY: '❌ Недостаточно токенов для повторной генерации.',
